...
import { ModelInstagram, ModelMe } from "./models";

import path from 'path';
import { Instagram } from "./instagram";
import { embedMessage } from "./helper";
//).config();
...
var channelId: string; //create new client
...
client.on('message', msg => {
  ...
  if (msg.content.includes("Insta Eater") || msg.content.includes("Insta-Eater")
    || msg.content.includes("Insta-eater") || msg.content.includes("Insta Eater")) {
...
var loop = () => {
  new Instagram().feeds().then((post?: ModelInstagram) => {
    ...
    if (post) {
      ...
      embedMessage(post, channel).then(() => {
